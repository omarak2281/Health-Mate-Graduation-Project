...
class SymptomCheckerService:
    ...
    def extract_symptoms(self, text: str) -> List[str]:
        ...
        synonyms = {
            ...
            "Sore Throat": ["throat pain", "scratchy throat", "احتقان", "احتقان الحلق", "التهاب الحلق", "وجع زور", "زورى واجعني", "عندي احتقان"],
            ...
            "Chest Pain": ["heart pain", "chest pressure", "الم صدر", "الم في الصدر", "ألم في الصدر", "نغزة", "ضيق صدر", "صدري بيوجعني", "نغزة بقلبي", "عندي الم بصدري"],

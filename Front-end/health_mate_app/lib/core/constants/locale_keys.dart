...
class LocaleKeys {
  ...
  static const String commonErrorWithDetails = 'common.error_with_details';
  ...
  static const String understood = 'common.understood';
  static const String commonNotAvailable = 'common.not_available';
  static const String commonAm = 'common.am';
  ...
  static const String commonStatusWithValue = 'common.status_with_value';
  ...
  static const String homeWelcomeUser = 'home.welcome_user';
  ...
  static const String splashInitializingMedicalSystems =
      'splash.initializing_medical_systems';
  ...
  static const String communicationIncomingVideoCall =
      'communication.incoming_video_call';
  static const String communicationIncomingAudioCall =
  ...
  static const String medicationsStatusWithBattery =
      'medications.status_with_battery';
  static const String medicationsStatusOnlineWithId =
      'medications.status_online_with_id';
  static const String medicationsStatusOffline = 'medications.status_offline';
  static const String medicationsBatteryLabel = 'medications.battery_label';
  static const String medicationsDrawerShort = 'medications.drawer_short';
  ...
  static const String medicationsConfirmTakenShort =
      'medications.confirm_taken_short';
  static const String medicationsSnoozeAction = 'medications.snooze_action';
  ...
  static const String medicationsTimeToTakeMeds =
      'medications.time_to_take_meds';
  ...
  static const String medicationsFailedToUploadImage =
      'medications.failed_to_upload_image';
  static const String medicationsDeleteMedicationConfirm =
      'medications.delete_medication_confirm';
  static const String medicationsDeleteMedicationConfirmWithName =
      'medications.delete_medication_confirm_with_name';
  ...
  static const String medicationsSelectDrawerRequired =
      'medications.select_drawer_required';
  ...
  static const String medicationsMedicationSummary =
      'medications.medication_summary';
  static const String medicationsDrawerWithNumber =
      'medications.drawer_with_number';
  static const String medicationsTimeTo = 'medications.time_to';
  static const String medicationsSnoozeFor = 'medications.snooze_for';
  static const String medicationsDrawerIsLit = 'medications.drawer_is_lit';
  static const String medicationsTime = 'medications.time';
  static const String medicationsMultipleTitle = 'medications.multiple_title';
  static const String medicationsMedicationNameHint =
      'medications.medication_name_hint';
  static const String medicationsInstructionsHint =
      'medications.instructions_hint';
  static const String medicationsDosageHint = 'medications.dosage_hint';
  static const String medicationsTimesDaily = 'medications.times_daily';
  static const String medicationsDoseNumber = 'medications.dose_number';
  static const String medicationsMedicationDeletedSuccess =
      'medications.medication_deleted_success';
  static const String medicationsDeleteMedicationTitle =
      'medications.delete_medication_title';
  ...
  static const String settingsAppVersion = 'settings.app_version';
  ...
  static const String errorsRequiresRecentLogin =
      'errors.requires_recent_login';
  ...
  static const String errorsFieldRequired = 'errors.field_required';
  ...
  // Symptom Checker
  static const String symptomCheckerTitle = 'symptom_checker.title';
  static const String symptomCheckerClinicalSpecialty =
      'symptom_checker.clinical_specialty';
  static const String symptomCheckerSelectSpecialty =
      'symptom_checker.select_specialty';
  static const String symptomCheckerHeartVascular =
      'symptom_checker.heart_vascular';
  static const String symptomCheckerCardiacSystem =
      'symptom_checker.cardiac_system';
  static const String symptomCheckerGeneralMedicine =
      'symptom_checker.general_medicine';
  static const String symptomCheckerComprehensive =
      'symptom_checker.comprehensive';
  static const String symptomCheckerSymptomAssessment =
      'symptom_checker.symptom_assessment';
  static const String symptomCheckerSelectSymptoms =
      'symptom_checker.select_symptoms';
  static const String symptomCheckerRefineCategory =
      'symptom_checker.refine_category';
  static const String symptomCheckerSelectSymptomsLabel =
      'symptom_checker.select_symptoms_label';
  static const String symptomCheckerAnalyzeSymptoms =
      'symptom_checker.analyze_symptoms';
  static const String symptomCheckerAiAnalysisComplete =
      'symptom_checker.ai_analysis_complete';
  static const String symptomCheckerViewModelMetrics =
      'symptom_checker.view_model_metrics';
  static const String symptomCheckerNewAssessment =
      'symptom_checker.new_assessment';
  static const String symptomCheckerExpertGuidance =
      'symptom_checker.expert_guidance';
  static const String symptomCheckerNoSymptomsSelected =
      'symptom_checker.no_symptoms_selected';
  static const String symptomCheckerNoSymptomsMessage =
      'symptom_checker.no_symptoms_message';
  static const String symptomCheckerLoadingData =
      'symptom_checker.loading_data';
  static const String symptomCheckerErrorLoading =
      'symptom_checker.error_loading';
  static const String symptomCheckerSpecialty = 'symptom_checker.specialty';
  static const String symptomCheckerSymptoms = 'symptom_checker.symptoms';
  static const String symptomCheckerAnalysis = 'symptom_checker.analysis';
  static const String symptomCheckerMetrics = 'symptom_checker.metrics';
  static const String symptomCheckerRiskLevel = 'symptom_checker.risk_level';
  static const String symptomCheckerConfidence = 'symptom_checker.confidence';
  static const String symptomCheckerSelectedCount =
      'symptom_checker.selected_count';
  static const String symptomCheckerTip = 'symptom_checker.tip';
  static const String symptomCheckerChooseSpecialty =
      'symptom_checker.choose_specialty';
  static const String symptomCheckerCategoryRespiratory =
      'symptom_checker.category_respiratory';
  static const String symptomCheckerCategoryNeurological =
      'symptom_checker.category_neurological';
  static const String symptomCheckerCategoryGastrointestinal =
      'symptom_checker.category_gastrointestinal';
  static const String symptomCheckerCategoryMusculoskeletal =
      'symptom_checker.category_musculoskeletal';
  static const String symptomCheckerCategoryOther =
      'symptom_checker.category_other';
  static const String symptomCheckerDate = 'symptom_checker.date';
  static const String symptomCheckerBack = 'symptom_checker.back';
  static const String symptomCheckerAiModelInfo =
      'symptom_checker.ai_model_info';
  static const String symptomCheckerModelInfoUnavailable =
      'symptom_checker.model_info_unavailable';
  static const String symptomCheckerUnknownError =
      'symptom_checker.unknown_error';

  // Permissions
  static const String permissionsOverlayTitle = 'permissions.overlay_title';
  static const String permissionsOverlayDescription =
      'permissions.overlay_description';
  static const String permissionsOverlayItemTitle =
      'permissions.overlay_item_title';
  static const String permissionsOverlayItemDesc =
      'permissions.overlay_item_desc';
  static const String permissionsOverlayInstruction =
      'permissions.overlay_instruction';
  static const String permissionsLater = 'permissions.later';
  static const String permissionsGrantPermission =

...
class ErrorMessages {
  ...
  static const String serversBusy = 'errors.servers_busy';
  ...
  // AI/Symptom Checker Errors
  static const String symptomAnalysisFailed = 'errors.symptom_analysis_failed';
  static const String invalidSymptomData = 'errors.invalid_symptom_data';
  static const String modelUnavailable = 'errors.model_unavailable';
  static const String categoriesLoadFailed = 'errors.categories_load_failed';
  static const String noSymptomsSelected = 'errors.no_symptoms_selected';

  // Generic Errors
  static const String unknownError = 'errors.unknown_error';
  static const String somethingWentWrong = 'errors.something_went_wrong';
  static const String pleaseTryAgain = 'errors.please_try_again';
}

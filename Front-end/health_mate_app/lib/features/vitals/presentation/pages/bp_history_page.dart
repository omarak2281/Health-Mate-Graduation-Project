...
class BPHistoryPage extends ConsumerStatefulWidget {
  ...
  const BPHistoryPage({super.key, this.patientId});
...
class _BPHistoryPageState extends ConsumerState<BPHistoryPage> {
  VitalsNotifier get _notifier => widget.patientId != null
      ? ref.read(patientVitalsNotifierProvider(widget.patientId!).notifier)
      : ref.read(vitalsNotifierProvider.notifier);

  VitalsState get _state => widget.patientId != null
      ? ref.watch(patientVitalsNotifierProvider(widget.patientId!))

  ...
  Future<void> _handleGoogleSignIn() async {
    ...
    if (result == true) {
      try {
        ...
        if (errorKey == 'errors.email_already_in_use') {
          if (!mounted) return;
          ...
          ProfessionalErrorHandler.showErrorDialog(
            ...
            subtitleKey:
                'You can use the sign-in page with your Google account.',
            showRetry: false,
          );
          ...
          ProfessionalErrorHandler.showErrorDialog(
            ...
            messageKey:
                'There\'s an issue with your Google account. Please try again or use email registration.',
            subtitleKey:
                'Make sure your Google account is active and has the necessary permissions.',
            showRetry: true,
            onRetry: _handleGoogleSignIn,
          );
        } else if (errorKey == 'errors.network_error') {
          if (!mounted) return;

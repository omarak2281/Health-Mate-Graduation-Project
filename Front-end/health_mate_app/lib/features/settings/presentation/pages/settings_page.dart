...
class _SettingsPageState extends ConsumerState<SettingsPage> {
      ...
      body: Container(
        ...
        child: ListView(
          ...
          children: [
            ...
            // Linked Companions Section (Only for patients)
            if (user?.isPatient == true) ...[
            ...
            Center(
              child: Text(
                LocaleKeys.settingsAppVersion.tr(
                    ...
                    return ListTile(
                      ...
                      subtitle: Row(
                        children: [
                          ...
                          Text(
                            LocaleKeys.commonStatusWithValue.tr(
                              namedArgs: {
                                'status': LocaleKeys.status.tr(),
                                'value': LocaleKeys.active.tr(),
                              },
                            ),
                            style: TextStyle(
                              fontSize: context.sp(12),
  ...
  Widget _buildDeviceStatusSection(bool isDark) {
    return Column(
      crossAxisAlignment: CrossAxisAlignment.start,
      children: [
        Text(
              ...
              Row(
                children: [
                  Container(
                    ...
                    decoration: BoxDecoration(
                      color: isDark
                          ? AppColors.expertTeal.withValues(alpha: 0.2)
                  ...
                  Expanded(
                    child: Column(
                      ...
                      children: [
                        ...
                        const ConnectivityStatusWidget(showText: true),
                      ],
                    ),
                  ),
                ],
